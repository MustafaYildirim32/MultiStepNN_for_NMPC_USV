...
#include "ROSbagTemplates.hpp" 
  std::shared_ptr<MATLABRosbagWriterInterface> 
          uuv_gazebo_ros_plugins_msgs_SetFloat_service::generateRosbagWriterInterface(ElementType type){
    std::shared_ptr<MATLABRosbagWriterInterface> ptr;
    if(type == eRequest){
        ptr = std::make_shared<ROSBagWriterImpl<uuv_gazebo_ros_plugins_msgs::SetFloatRequest,uuv_gazebo_ros_plugins_msgs_msg_SetFloatRequest_common>>();
    }else if(type == eResponse){
        ptr = std::make_shared<ROSBagWriterImpl<uuv_gazebo_ros_plugins_msgs::SetFloatResponse,uuv_gazebo_ros_plugins_msgs_msg_SetFloatResponse_common>>();
    }else{
        throw std::invalid_argument("Wrong input, Expected 'Request' or 'Response'");
    }
    return ptr;
...
CLASS_LOADER_REGISTER_CLASS(uuv_gazebo_ros_plugins_msgs_msg_SetFloatRequest_common, MATLABROSMsgInterface<uuv_gazebo_ros_plugins_msgs::SetFloatRequest>)
CLASS_LOADER_REGISTER_CLASS(uuv_gazebo_ros_plugins_msgs_msg_SetFloatResponse_common, MATLABROSMsgInterface<uuv_gazebo_ros_plugins_msgs::SetFloatResponse>)
