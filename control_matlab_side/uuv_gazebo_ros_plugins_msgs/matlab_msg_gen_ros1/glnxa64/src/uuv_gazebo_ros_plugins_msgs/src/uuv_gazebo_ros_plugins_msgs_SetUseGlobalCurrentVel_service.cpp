...
#include "ROSbagTemplates.hpp" 
  std::shared_ptr<MATLABRosbagWriterInterface> 
          uuv_gazebo_ros_plugins_msgs_SetUseGlobalCurrentVel_service::generateRosbagWriterInterface(ElementType type){
    std::shared_ptr<MATLABRosbagWriterInterface> ptr;
    if(type == eRequest){
        ptr = std::make_shared<ROSBagWriterImpl<uuv_gazebo_ros_plugins_msgs::SetUseGlobalCurrentVelRequest,uuv_gazebo_ros_plugins_msgs_msg_SetUseGlobalCurrentVelRequest_common>>();
    }else if(type == eResponse){
        ptr = std::make_shared<ROSBagWriterImpl<uuv_gazebo_ros_plugins_msgs::SetUseGlobalCurrentVelResponse,uuv_gazebo_ros_plugins_msgs_msg_SetUseGlobalCurrentVelResponse_common>>();
    }else{
        throw std::invalid_argument("Wrong input, Expected 'Request' or 'Response'");
    }
    return ptr;
...
CLASS_LOADER_REGISTER_CLASS(uuv_gazebo_ros_plugins_msgs_msg_SetUseGlobalCurrentVelRequest_common, MATLABROSMsgInterface<uuv_gazebo_ros_plugins_msgs::SetUseGlobalCurrentVelRequest>)
CLASS_LOADER_REGISTER_CLASS(uuv_gazebo_ros_plugins_msgs_msg_SetUseGlobalCurrentVelResponse_common, MATLABROSMsgInterface<uuv_gazebo_ros_plugins_msgs::SetUseGlobalCurrentVelResponse>)
